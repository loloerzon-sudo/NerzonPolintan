...
[![Profile](https://img.shields.io/badge/Cognitive_Profile-INTJ--A-b8f04a?style=for-the-badge&logo=speedtest&logoColor=0a0c0e)](https://nerzon.online/personality.html)
...
🚀 **[https://nerzon.online/](https://nerzon.online/)**  
🧠 **[https://nerzon.online/personality.html](https://nerzon.online/personality.html)** *(INTJ-A Cognitive Diagnostic Report)*
...
* **Tailored Dark Palette**: Low-fatigue `#0a0c0e` carbon background with vibrant `#b8f04a` neon lime accents.
* **Dual World Clocks**: Live synchronized clocks for **Manila (MNL / GMT+8)** and **Malta (MLT / CET)**.
...
### 3. 🧠 INTJ-A Cognitive Blueprint (`personality.html`)
...
```text
├── index.html              # Main Portfolio Console
├── personality.html        # INTJ-A Cognitive Profile & Diagnostic Report
├── README.md               # Documentation & repository overview
└── assets/
    ├── documents/
    │   └── John-Nerzon-Polintan-CV-2026.pdf
    ├── fonts/
    ...
    └── images/
        ...
        ├── brand-identity-assets.jpg
        ├── competition-operations-workflow.png
        ├── igaming-provider-network.jpg
        ├── john-nerzon-polintan-profile.png
        ├── nerzon-online-qr-card.png
        ├── nerzon-online-qr-dark.png
        ├── nerzon-online-qr-light.png
        ├── nerzon-online-qr.svg
        ├── servicenow-ticketing-console.jpg
        └── ...
```
...
No build steps or package managers required. Simply clone and open:
