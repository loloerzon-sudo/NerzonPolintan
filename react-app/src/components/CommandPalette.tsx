...
export function CommandPalette({ isOpen, onClose, onCopyEmail, onMatrixRain, onOpenTerminal }: CommandPaletteProps) {
  ...
  const COMMANDS: Cmd[] = [
    ...
    { id: 'sec-05', cat: 'SECTION', label: '05 — Services (Console)', key: 'JUMP', action: () => { navigate('/console#services'); } },
    { id: 'sec-06', cat: 'SECTION', label: '06 — Credentials (Console)', key: 'JUMP', action: () => { navigate('/console#credentials'); } },
    { id: 'sec-07', cat: 'SECTION', label: '07 — Contact (Console)', key: 'JUMP', action: () => { navigate('/console#contact'); } },
